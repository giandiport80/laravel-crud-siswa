        ...
        <div class="auth-box ">
          <div class="left">
            <div class="content">
              ...
              <form class="form-auth-small" action="{{ route('auth.post') }}" method="POST">
                @csrf

                <div class="form-group">
                  <label for="signin-email" class="control-label sr-only">Email</label>
                  <input type="email" name="email" class="form-control" id="signin-email" placeholder="Email" autofocus>
                </div>
          ...
          <div class="right">
            ...
            <div class="content text">
              <h1 class="heading">Laravel Crud Siswa</h1>
              <p>by Gian Nurwana</p>
            </div>
          </div>
