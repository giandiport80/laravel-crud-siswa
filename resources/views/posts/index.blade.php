        ...
        <tr>
          ...
          <td>
            <form action="{{ route('siswa.destroy', $post->id) }}" method="POST">
              ...
              <a href="{{ route('site.singlePost', $post->slug) }}" target="_blank" class="btn btn-info btn-sm" title="Edit data siswa">View</a>
              <a href="/siswa/{{ $post->id }}/edit" class="btn btn-success btn-sm" title="Edit data siswa">Edit</a>
