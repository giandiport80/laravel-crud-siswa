...
@section('content')
<!-- start banner Area -->
<section class="banner-area relative" id="home" style="background-image: url({{ config('sekolah.image_banner_url') }})">
      ...
      <div class="col-lg-4">
        <div class="single-feature">
          ...
          <div class="desc-wrap">
            ...
            <a
              href="{{ config('sekolah.home_feature_column_1_link_url') }}">{{ config('sekolah.home_feature_column_1_link_text') }}</a>
          </div>
        </div>
      </div>
      <div class="col-lg-4">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 single-blog">
        <div class="thumb">
          <img class="img-fluid" src="{{ $post->tumbnail() }}" alt="">
        </div>
        ...
        {!! $post->content !!}
        <a href="{{ route('site.singlePost', $post->slug) }}" class="details-btn d-flex justify-content-center align-items-center"><span
